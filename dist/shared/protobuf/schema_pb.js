...
proto.Player.serializeBinaryToWriter = function (message, writer) {
    ...
    f = message.getMoving();
    if (f != null) {
        writer.writeMessage(7, f, proto.Movement.serializeBinaryToWriter);
    }
    f = message.getSpeed();
    if (f !== 0.0) {
...
proto.Player.prototype.getMoving = function () {
    return /** @type{?proto.Movement} */ (jspb.Message.getWrapperField(this, proto.Movement, 7));
};
/**
...
proto.PlayersState.prototype.getPlayersMap = function (opt_noLazyCreate) {
    return /** @type {!jspb.Map<number,!proto.Player>} */ (jspb.Message.getMapField(this, 1, opt_noLazyCreate, proto.Player));
};
/**
...
if (jspb.Message.GENERATE_TO_OBJECT) {
    ...
    proto.Snapshot.toObject = function (includeInstance, msg) {
        var f, obj = {
            ...
            stateList: jspb.Message.toObjectList(msg.getStateList(), proto.Position.toObject, includeInstance)
        };
        if (includeInstance) {
            obj.$jspbMessageInstance = msg;
        }
...
proto.Snapshot.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f.length > 0) {
        writer.writeRepeatedMessage(3, f, proto.Position.serializeBinaryToWriter);
    }
};
/**
...
proto.Snapshot.prototype.getStateList = function () {
    return /** @type{!Array<!proto.Position>} */ (jspb.Message.getRepeatedWrapperField(this, proto.Position, 3));
};
/**
...
proto.ClientPacket.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(3, f, proto.MovementInput.serializeBinaryToWriter);
    }
    f = message.getMessage();
    if (f != null) {
        writer.writeMessage(4, f, proto.Message.serializeBinaryToWriter);
    }
    f = message.getLogin();
    if (f != null) {
        writer.writeMessage(5, f, proto.Login.serializeBinaryToWriter);
    }
    ...
    f = message.getUpdate();
    if (f != null) {
        writer.writeMessage(7, f, proto.UpdateAccount.serializeBinaryToWriter);
    }
...
proto.ClientPacket.prototype.getMovementinput = function () {
    return /** @type{?proto.MovementInput} */ (jspb.Message.getWrapperField(this, proto.MovementInput, 3));
};
/**
...
proto.ClientPacket.prototype.getMessage = function () {
    return /** @type{?proto.Message} */ (jspb.Message.getWrapperField(this, proto.Message, 4));
};
/**
...
proto.ClientPacket.prototype.getLogin = function () {
    return /** @type{?proto.Login} */ (jspb.Message.getWrapperField(this, proto.Login, 5));
};
/**
...
proto.ClientPacket.prototype.getUpdate = function () {
    return /** @type{?proto.UpdateAccount} */ (jspb.Message.getWrapperField(this, proto.UpdateAccount, 7));
};
/**
...
proto.ServerPacket.serializeBinaryToWriter = function (message, writer) {
    ...
    if (f != null) {
        writer.writeMessage(3, f, proto.PlayersState.serializeBinaryToWriter);
    }
    ...
    if (f != null) {
        writer.writeMessage(5, f, proto.Snapshot.serializeBinaryToWriter);
    }
    f = message.getMessage();
    if (f != null) {
        writer.writeMessage(6, f, proto.Message.serializeBinaryToWriter);
    }
    ...
    f = message.getAttack();
    if (f != null) {
        writer.writeMessage(8, f, proto.Attack.serializeBinaryToWriter);
    }
};
/**
...
proto.ServerPacket.prototype.getPlayers = function () {
    return /** @type{?proto.PlayersState} */ (jspb.Message.getWrapperField(this, proto.PlayersState, 3));
};
/**
...
proto.ServerPacket.prototype.getSnapshot = function () {
    return /** @type{?proto.Snapshot} */ (jspb.Message.getWrapperField(this, proto.Snapshot, 5));
};
/**
...
proto.ServerPacket.prototype.getMessage = function () {
    return /** @type{?proto.Message} */ (jspb.Message.getWrapperField(this, proto.Message, 6));
};
/**
 * @param {?proto.Message|undefined} value
 * @return {!proto.ServerPacket} returns this
...
proto.ServerPacket.prototype.getAttack = function () {
    return /** @type{?proto.Attack} */ (jspb.Message.getWrapperField(this, proto.Attack, 8));
};
/**
